...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`transmitter` (
  ...
  INDEX `fk_transmitter_reciver_in_diff_v1_idx` (`reciver_in_diff_v_id` ASC),
  CONSTRAINT `fk_transmitter_rise_and_fall_time_signal1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_transmitter_reciver_in_diff_v1`
...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`power_requirements` (
  ...
  INDEX `fk_power_requirements_plus5v1_idx` (`plus5v_id` ASC),
  ...
  CONSTRAINT `fk_power_requirements_plus12vPause1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_power_requirements_plus5v1`
...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`device_manager` (
  ...
  INDEX `fk_device_manager_out_diff_volt1_idx` (`out_diff_volt_id` ASC),
  ...
  CONSTRAINT `fk_device_manager_power_requirements1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_device_manager_out_diff_volt1`
...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`reports` (
  ...
  UNIQUE INDEX `create_date_UNIQUE` (`create_date` ASC),
...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`hard_soft_data` (
  ...
  `proc_count_log` INT(2) NOT NULL,
  `proc_count_phys` INT(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`statistics_program` (
  ...
  `hard_soft_data_id1` INT(5) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `runtime_UNIQUE` (`runtime` ASC),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_statistics_program_hard_soft_data1_idx` (`hard_soft_data_id1` ASC),
  CONSTRAINT `fk_statistics_program_hard_soft_data1`
    FOREIGN KEY (`hard_soft_data_id1`)
    REFERENCES `isvsk_v2`.`hard_soft_data` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `isvsk_v2`.`report_of_system`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`report_of_system` (
  `id` INT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(45) NOT NULL,
  `path_to_file` VARCHAR(45) NOT NULL,
  `create_date` DATETIME NOT NULL,
  `statistics_program_id` INT(3) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  UNIQUE INDEX `title_UNIQUE` (`title` ASC),
  UNIQUE INDEX `create_date_UNIQUE` (`create_date` ASC),
  UNIQUE INDEX `path_to_file_UNIQUE` (`path_to_file` ASC),
  INDEX `fk_report_of_system_statistics_program1_idx` (`statistics_program_id` ASC),
  CONSTRAINT `fk_report_of_system_statistics_program1`
    FOREIGN KEY (`statistics_program_id`)
    REFERENCES `isvsk_v2`.`statistics_program` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `isvsk_v2`.`reports_has_device_manager` (
  ...
  CONSTRAINT `fk_reports_has_device_manager_device_manager1`
    FOREIGN KEY (`device_manager_inventnumber`)
    REFERENCES `isvsk_v2`.`device_manager` (`inventnumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
